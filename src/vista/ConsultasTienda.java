 ...
 * @author W°
 */
public class ConsultasTienda extends javax.swing.JFrame {

    
    LinkedList<Tienda> listaTiendas;
    /**
     * Creates new form ConsultasTienda
     */
    public ConsultasTienda() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "idTienda", "Nombre", "Direccion", "Descripcion", "FechaAprobacion", "idAdmin", "idClienteV", "idFotoP"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jButton2.setText("No Aprobadas");
        ...
        jLabel1.setText("Tiendas aprobadas y no aprobadas");
...
//                fila[5] = listaTiendas.get(i).getAprobacionTienda();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultasTienda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultasTienda().setVisible(true);
            }
        });
    }

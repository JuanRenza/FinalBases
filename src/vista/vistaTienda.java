...
public class vistaTienda extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String criterioBusqueda = jTextField1.getText();
        ControlTienda objcc = new ControlTienda();
        File archivo = new File(jTextField4.getText());
        int ncol=10;
        Object[] fila;
...
//        String identificacion = jTextField1.getText();
        ...
        int aprobacion = Integer.parseInt(jTextField6.getText());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        ControlTienda objcp = new ControlTienda();
        boolean t = objcp.actualizarTienda(nombre, direccion, descripcion, aprobacion, fechaaprobacion, idadmin, idcvf, idfotop, id);
        if (t == true) {
